...
$smtp.Credentials = New-Object System.Net.NetworkCredential("kannangupta20@outlook.com", "Kannan@Microsoft");
$smtp.EnableSsl = $true
$Message.From = "kannangupta20@outlook.com"
$Message.To.Add("mahaveerchoudhary6886@gmail.com")
